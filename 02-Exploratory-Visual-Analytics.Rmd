...
There are 142 countries in the **gapminder** data but only 139 in the data we collected that match those 142 countries. There might ge names in **gapminder** that are different from those from the imported data. We will check this idea first.
...
We need the full list of countries in the orginal data to change the names.
