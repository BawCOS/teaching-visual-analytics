...
To aviod the temporary variables, use the code below in one step.
...
We have been using visualization to find grouping of data to separate into two groups. An alternative is to use hierarchical clustering. Now apply hierarchial clustering to our data.
...
Table \@ref(tab:tab-clust1) at the second cluster to find the countries in the cluster.
...
Table \@ref(tab:tab-clust2) repeats for the first cluster.
...
Which plots worked did we can an insight into developed versus developing countries?

ADD MORE here. An increase in life expectancy and a decrease in fertility.
