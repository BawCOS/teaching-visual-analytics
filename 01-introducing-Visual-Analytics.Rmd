...
The angle is the batting average, should we use white space and put an explanation into the graph?  What if we had three years, how would we represent them? The labels overlap the lines, should we move them?  As a lead into the next lesson on interaction, selecting a year and turning it off as well as making lines more transparent could help.
...
You can construct these plots in R although they are a bit awkward however we can control the aspect ratio, offset text, change the font size.  To get an idea of how to do this consider 
...
arrows(0,0,411,104,col="blue")
arrows(411,104,(411+140),(104+45),col="blue")
arrows(0,0,(411+140),(104+45),col="blue")
abline(0,1)
title("Batting Averages")
legend(1, 200, legend=c("Derek Jeter", "David Justice"),
