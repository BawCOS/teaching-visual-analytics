...
These notes make use of the following packages in R **knitr** [@R-knitr], **rmarkdown** [@R-rmarkdown], **fastR** [@R-fastR], **Hmisc** [@R-Hmisc], **lattice** [@R-lattice], **vcd** [@R-vcd], **ggplot2** [@R-ggplot2], **MASS** [@R-MASS], **TeachingDemos** [@R-TeachingDemos], **Stat2Data** [@R-Stat2Data], **car** [@R-car], **DT** [@R-DT],**crosstalk** [@R-crosstalk], **leaflet** [@R-leaflet], **plotly** [@R-plotly], **ggrepel**[@R-ggrepel], **rpivotTable**[@R-rpivotTable], **RColorBrewer**[@R-RColorBrewer], **gapminder**[@R-gapminder], **tidyverse**[@R-tidyverse], **readxl**[@R-readxl].
...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown','fastR','Hmisc','lattice','vcd','ggplot2','MASS','TeachingDemos','Stat2Data','car','DT','leaflet','crosstalk','plotly','tidyr','vcdExtra','ggrepel', 'shiny', 'rpivotTable','ggrepel','d3scatter','RColorBrewer','gapminder','tidyverse','readxl'
), 'packages.bib')
```
