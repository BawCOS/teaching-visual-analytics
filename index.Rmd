...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown','Hmisc','lattice','vcd','ggplot2','MASS','TeachingDemos','Stat2Data','car','DT','leaflet','crosstalk','plotly','tidyr','vcdExtra','ggrepel', 'shiny', 'rpivotTable','ggrepel','d3scatter','RColorBrewer','gapminder','tidyverse','readxl','kableExtra','GGally','ggthemes'
), 'packages.bib')
```
